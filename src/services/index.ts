...
export class PortkeyService {
	...
	constructor() {
		...
		this.configs = new ConfigsService();
		this.keys = new KeysService();
		this.collections = new CollectionsService();
		this.prompts = new PromptsService();
		this.analytics = new AnalyticsService();
		this.guardrails = new GuardrailsService();
		this.integrations = new IntegrationsService();
		this.limits = new LimitsService();
		this.audit = new AuditService();
		this.labels = new LabelsService();
		this.partials = new PartialsService();
		this.tracing = new TracingService();
		this.logging = new LoggingService();
		this.providers = new ProvidersService();
	}
